...
func main() {
	...
	svc := gateway.NewService(cfg.ProductServiceURL, cfg.OrderServiceURL, httpClient)
	...
	slog.Info("starting gateway", "addr", addr, "product_service", cfg.ProductServiceURL, "order_service", cfg.OrderServiceURL)
